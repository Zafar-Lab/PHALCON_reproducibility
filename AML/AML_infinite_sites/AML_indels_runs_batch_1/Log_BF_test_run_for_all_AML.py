...
nonbulkevident_sites_df = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_1/AML_indels_nonbulk_evident_sites_dbsnp_nonzero_statistical_BF_test.tsv",sep='\t')
...
frames=[]
for aml_file_name in samples_available:
    log_bf_test_df = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_1/"+aml_file_name+"/Statistical_test/Log BF test.txt")
