...
# Save summary
summary_df.to_csv("/home/priya/Downloads/Final_Stage/AML_results_finite_sites/AML_indels_run_finite_sites_batch_1/loss_summary_all_patients.tsv", sep="\t", index=False)
