...
tree_nw = Tree("(((7,8),(9,10)),(((11,12),(13,14)),(((((0,1),2),3),4),(5,6))));")
data = 4
no_of_clusters = 15
print(tree_nw)
...
# basically making the cell cluster mapping using a dictionary
...
with open('True_tree_15_2000_data_'+str(data)+'.gv','w') as f:
  f.write('digraph G {\n')
  for node in tree_nw.traverse("preorder"):
