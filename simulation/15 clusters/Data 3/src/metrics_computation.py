...
best_labels = np.loadtxt('sc_2000_inferred_cluster_labels.txt')   # Inferred cluster labels
df_obtained_rc = pd.read_csv('sc_2000_final_df.tsv',header=None,sep='\t')     # Final inferred read count matrix


# Ground Truth ##############################################################################################################################################
trueGenofile = "/home/priya/Downloads/Final Stage/Benchmarking/15 clusters/Data 3/simulation/Genotype_data_2000_50.tsv"    # True genotype 
trueLabelfile = '/home/priya/Downloads/Final Stage/Benchmarking/15 clusters/Data 3/simulation/ccm_2000_50.txt'   # True cell to cluster map
trueVCF = '/home/priya/Downloads/Final Stage/Benchmarking/15 clusters/Data 3/simulation/sc_2000_inclusion_output.vcf'
