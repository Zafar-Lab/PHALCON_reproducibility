...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Benchmarking/Back increased/Data 3/simulation/sc_2000_readCounts_3.tsv')  # CHANGE HERE
...
argParser.add_argument('-s', '--seed', type=int, default = 13)
