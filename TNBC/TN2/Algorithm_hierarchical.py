...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Real Data Results/TN2/readCounts_MBTN2_nodups.tsv')
argParser.add_argument('-g', '--inQualityFileName', type=str,default = '/home/priya/Downloads/Final Stage/Real Data Results/TN2/gq_file_TN2.tsv')
argParser.add_argument('-o', '--outputPrefix', type=str,default='TN2_orig_hierarchical_')
...
argParser.add_argument('-s', '--seed', type=int, default = 1001)
