...
print("Shape after filtering sciphi indices :", phylo_data_1_2000_10.shape)
phylo_data_1_2000_10.to_csv('phylo_input_data_1_2000_10.mpileup',sep='\t',header=False, index=False)