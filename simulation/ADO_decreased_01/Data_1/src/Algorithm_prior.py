...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Benchmarking/ADO_decreased_01/Data_1/simulation/sc_2000_readCounts_1.tsv')  # CHANGE HERE
...
argParser.add_argument('-s', '--seed', type=int, default = 11129)
