...
vcf_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/Back increased/Data '+str(data_no)+'/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)
# the original genotype matrix from simulation
df_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/Back increased/Data '+str(data_no)+'/simulation/Genotype_data_2000_50.tsv',sep='\t',header=None)
...
with open('Phylovar_back_data_'+str(data_no)+'_empty_removed.gv','w') as f:
  f.write('digraph G {\n')
  for node in tree_nw.traverse("preorder"):
