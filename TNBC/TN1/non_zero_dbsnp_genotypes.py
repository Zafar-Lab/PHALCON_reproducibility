...
print(vcf_df)
final_df_manual = pd.read_csv('/home/priya/Downloads/Final_Stage/Real Data Results/TN1/Hierarchical_prior_FINAL/TN1_orig_hierarchical_final_df_check.tsv',header=None,sep=',')
