...
argParser.add_argument('-s', '--seed', type=int, default = 179015) 
...
argParser.add_argument('-C','--copyNumberRate',type=float,default = 0.5)
...
rcFileName = prefixName +'readCounts_4'+ '.tsv'
numPos = args.numPos
