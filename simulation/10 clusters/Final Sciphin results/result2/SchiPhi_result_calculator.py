...
vcf_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/10 clusters/Data 2/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)
# the original genotype matrix from simulation
mutated_pos = set(vcf_orig[1]) #mutated positions in the original genotype matrix

df_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/10 clusters/Data 2/simulation/Genotype_data_2000_50.tsv',sep='\t',header=None)
