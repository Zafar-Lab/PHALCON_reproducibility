...
vcf_obtained = np.loadtxt('data_ado_'+str(data_no)+'_2000_10.vcf',dtype='str')
...
phylo_data.to_csv('phylo_input_data_ado_'+str(data_no)+'_2000_10.mpileup',sep='\t',header=False, index=False)