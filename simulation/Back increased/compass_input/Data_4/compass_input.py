...
data_no = '4'
no_clusters = 'back'
orig_df = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/Back increased/Data '+data_no+'/simulation/sc_2000_readCounts_'+data_no+'.tsv',header=None, sep='\t')
mutated_pos = np.array(np.loadtxt('/home/priya/Downloads/Final Stage/Benchmarking/Back increased/Data '+data_no+'/simulation/sc_2000_inclusion_output.vcf',dtype='object')[:,1],dtype='int')
