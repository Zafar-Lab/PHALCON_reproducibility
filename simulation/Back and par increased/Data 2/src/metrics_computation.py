...
best_labels = np.loadtxt('/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/src/sc_2000_inferred_cluster_labels.txt')
true_cluster_labels = np.loadtxt('/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/simulation/ccm_2000_50.txt')  # CHANGE HERE
true_cluster_labels = np.delete(true_cluster_labels, (0), axis=0)
true_cluster_labels = true_cluster_labels[0]
trueGenofile = "/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/simulation/Genotype_data_2000_50.tsv"  #CHANGE HERE

df_orig = pd.read_csv(trueGenofile,sep='\t',header=None)

final_df = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)

df_obtained_rc = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/src/sc_2000_final_df.tsv',header=None,sep='\t')
