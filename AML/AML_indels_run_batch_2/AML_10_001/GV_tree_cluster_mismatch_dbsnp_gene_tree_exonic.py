...
dbsnp_non_zero_avinput_file_name = '//home/priya/Downloads/Final_Stage/AML_results_finite_sites/AML_indels_run_finite_sites_batch_2/'+data+'/'+data+'_indels_dbsnp_non_zero_finite_sites.avinput.variant_function'
