...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Real Data Results/TN5/readCounts_MBTN5_nodups.tsv')
argParser.add_argument('-g', '--inQualityFileName', type=str,default = '/home/priya/Downloads/Final Stage/Real Data Results/TN5/gq_file_TN5.tsv')
argParser.add_argument('-o', '--outputPrefix', type=str,default='TN5_orig_spectral_')
...
argParser.add_argument('-s', '--seed', type=int, default = 1051)
