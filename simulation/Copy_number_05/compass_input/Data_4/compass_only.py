...
gv_modified_compass = '/home/priya/Downloads/Final_Stage/COMPASS/CPN_05/Data_'+data_no+'/Set 1/Compass_2000_'+no_clusters+'_'+data_no+'_tree_modified.gv'  
...
for i in range(len(new_content)):
  ...
  line4 = re.sub("\\n",'',new_content[i])
  new_content[i] = line4
  line5 = re.sub("(,+)<B>CNLOH Region(\d+):ALT,ALT </B>",'',new_content[i])
  new_content[i] = line5
