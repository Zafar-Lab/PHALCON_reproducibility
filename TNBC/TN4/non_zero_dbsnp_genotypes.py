...
print(vcf_df)
final_df_manual = pd.read_csv('/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Hierarchical_prior_FINAL/'+data+'_orig_hierarchical_final_df_manual_sites_removed.tsv',header=None,sep=',')
