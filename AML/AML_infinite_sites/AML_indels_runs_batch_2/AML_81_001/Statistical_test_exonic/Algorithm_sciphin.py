...
for i in tqdm(range(muts),desc='Computing likelihoods... '):
    ...
    print("fp rate across genome", fp_rate_across_genome)
    print("total sites :",total_sites)
    print("mutated sites :",mutated_sites)
    ...
    print("alpha_wild_0 ",alpha_wild_0)
    print("beta_wild_0 ",beta_wild_0)
    ...
    print("mut_mean_2 ",mut_mean_2)
    print("alpha_mut_2 ",alpha_mut_2)
    print("beta_mut_2 ",beta_mut_2)
