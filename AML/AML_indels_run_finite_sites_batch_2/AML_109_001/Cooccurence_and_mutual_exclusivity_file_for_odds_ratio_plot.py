...
final_vcf_file = "/home/priya/Downloads/Final_Stage/AML_results_finite_sites/AML_indels_run_finite_sites_batch_2/"+data+"/"+data+"_indels_nonzero_dbsnp_finite_sites_outputInference.vcf"
final_variant_file = "/home/priya/Downloads/Final_Stage/AML_results_finite_sites/AML_indels_run_finite_sites_batch_2/"+data+"/"+data+"_indels_dbsnp_non_zero_finite_sites.avinput.variant_function"
...
print(df_genotype.T)
df_genotype.T.to_csv("input_"+data+"_for_odds_ratio_plot_finite_sites.csv",sep=',',header=None,index=False)
