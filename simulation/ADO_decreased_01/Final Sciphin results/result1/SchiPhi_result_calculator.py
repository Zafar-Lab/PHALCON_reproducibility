...
data_no = '1'
vcf_obtained = np.loadtxt('data_ado_dec_'+data_no+'_2000_10.vcf',dtype='str')
...
vcf_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/ADO_decreased_01/Data_'+data_no+'/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)
# the original genotype matrix from simulation
df_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/ADO_decreased_01/Data_'+data_no+'/simulation/Genotype_data_2000_50.tsv',sep='\t',header=None)
