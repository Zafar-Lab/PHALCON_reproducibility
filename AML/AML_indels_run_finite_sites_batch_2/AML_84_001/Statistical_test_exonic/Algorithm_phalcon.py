...
# Find best likelihoods among a set of chosen number of clusters
    ...
    cluster_labels = np.loadtxt('/home/priya/Documents/priya/Log_bf_finite_sites/AML_indels_run_finite_sites_batch_2/'+data+'/'+data+'_indels_finite_sites_inferred_cluster_labels.txt',dtype='float')
...
df_for_sites = pd.read_csv("/home/priya/Documents/priya/Log_bf_finite_sites/finite_sites_exonic_not_detected_in_bulk.csv")
