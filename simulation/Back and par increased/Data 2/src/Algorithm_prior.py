...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Benchmarking/Back and par increased/Data 2/simulation/sc_2000_readCounts_2.tsv')  # CHANGE HERE
...
argParser.add_argument('-s', '--seed', type=int, default = 1799)
