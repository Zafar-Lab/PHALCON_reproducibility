...
best_labels = np.loadtxt('/home/priya/Downloads/Final_Stage/Benchmarking/'+benchmark+'/Data '+str(data_no)+'/src/sc_2000_inferred_cluster_labels.txt')   # Inferred cluster labels
df_obtained_rc = pd.read_csv('/home/priya/Downloads/Final_Stage/Benchmarking/'+benchmark+'/Data '+str(data_no)+'/src/sc_2000_final_df.tsv',header=None,sep='\t')     # Final inferred read count matrix


# Ground Truth ##############################################################################################################################################
trueGenofile = '/home/priya/Downloads/Final_Stage/Benchmarking/'+benchmark+'/Data '+str(data_no)+'/simulation/Genotype_data_2000_50.tsv'    # True genotype 
trueLabelfile = '/home/priya/Downloads/Final_Stage/Benchmarking/'+benchmark+'/Data '+str(data_no)+'/simulation/ccm_2000_50.txt'   # True cell to cluster map
trueVCF = '/home/priya/Downloads/Final_Stage/Benchmarking/'+benchmark+'/Data '+str(data_no)+'/simulation/sc_2000_inclusion_output.vcf'
