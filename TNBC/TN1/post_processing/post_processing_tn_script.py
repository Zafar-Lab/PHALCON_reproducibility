...
os.system('prefetch '+accession_no)
os.system('fasterq-dump '+accession_no)
os.system("bowtie2 --no-unal -p 4 -x hg19 -1 "+ accession_no +"_1.fastq -2 " + accession_no + "_2.fastq -S "+ data + ".sam")
os.system("samtools view -@ 4 -Sb -o "+ data +".bam " + data + ".sam")
os.system("samtools sort " + data + ".bam -o " + data + "_sorted.bam")
os.system("rm "+ data + ".bam")
os.system("rm "+ accession_no +"_1.fastq")
os.system("rm "+ accession_no +"_2.fastq")
os.system("rm -rf "+ accession_no)
os.system("rm "+ data + ".sam")
...
# removing variants present in bulk normal files

avinput_dir = 'TN1_dbsnp_nz.avinput'
os.system("perl convert2annovar.pl -format vcf4 "+data+"_orig_hierarchical_dbsnp_non_zero_outputInference.vcf -outfile "+avinput_dir+"--allsample -withfreq")
os.system("perl annotate_variation.pl -buildver hg19 "+avinput_dir+" humandb/") 
...
avinput_df.to_csv(data+'_dbsnp_nz.bed',sep='\t',index=None,header=False)

command = "samtools mpileup -l "+data+"_dbsnp_nz.bed "+data+"_N_sorted.bam -o "+data+"_N.mpileup"
os.system(command)
