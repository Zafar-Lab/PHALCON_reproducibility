...
vcf_obtained = np.loadtxt('/home/priya/Downloads/Final_Stage/Benchmarking/Copy_number_05/Sciphin_results/result'+data+'/data_cpn_05_'+data+'_2000_10.vcf',dtype='str')
...
phylo_back_data_1_2000_10.to_csv('phylo_input_data_cpn_05_'+data+'_2000_10.mpileup',sep='\t',header=False, index=False)