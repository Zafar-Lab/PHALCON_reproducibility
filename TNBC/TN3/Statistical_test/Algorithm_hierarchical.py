...
print(df)
list_bulk_evidence_not_found = [127379885,47196587,15291525,33762586,235969636,57398186,1284370,108589807,47196591]
df = df[df[1].isin([47196591])]
print(df)
df = df.to_numpy()
...
if isQualityFilteringOn: 
   ...
   df_gq = df_gq[df_gq[0].isin([47196591])]
...
Labelfile = '/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Hierarchical_prior_FINAL/Statistical_test/'+data+'_orig_hierarchical_inferred_cluster_labels_modified.txt'   # True cell to cluster map
