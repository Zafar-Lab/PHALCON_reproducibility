...
df_all_variants = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_results_finite_sites/Fraction of cells for manual oncoplot finite sites/AML_top_variants_fraction_of_mutated_cells_finite_cells.tsv",sep='\t')
...
manual_oncoplot.to_csv("Dataframe_for_manual_oncoplot_creation_AML_gene_wise_finite_sites.tsv",sep='\t',header=True,index=True)


df = pd.read_csv("Dataframe_for_manual_oncoplot_creation_AML_gene_wise_finite_sites.tsv",sep='\t',index_col=[0])
df[df > 0] = 1
