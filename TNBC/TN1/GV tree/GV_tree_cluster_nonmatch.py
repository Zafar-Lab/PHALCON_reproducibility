...
tree_nw = Tree("(((0,1),2),(5,(4,(3,(8,(6,7))))));")
data = 'TN1'
...
orig_pos = pd.read_csv('TN1_orig_hierarchical_final_df.tsv',sep=',',header=None) # this is the dataframe which is obtained after post processing and everything
config = pd.read_csv('/home/priya/Downloads/Final Stage/Real Data Results/TN1/Hierarchical_prior_FINAL/Genotype configuration.tsv',sep='\t',header=None) # Genotype configuration file
before_post_process_file = pd.read_csv('/home/priya/Downloads/Final Stage/Real Data Results/TN1/Hierarchical_prior_FINAL/TN1_orig_hierarchical_final_df.tsv',sep='\t',header=None) # final data frame for finding the sites which are mutated
...
cluster_labels = list(np.loadtxt('/home/priya/Downloads/Final Stage/Real Data Results/TN1/Hierarchical_prior_FINAL/TN1_orig_hierarchical_inferred_cluster_labels.txt',dtype='int')) # now finding the labels corresponding to each unique cell
columns = dict()
