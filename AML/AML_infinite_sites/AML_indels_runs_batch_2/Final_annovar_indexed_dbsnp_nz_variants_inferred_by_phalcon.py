...
for aml_file_name in sub_folders:
    ...
    phalcon_df = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/"+aml_file_name+"/"+aml_file_name+"_indels_final_df.tsv",sep='\t',header=None)
    final_variants = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/"+aml_file_name+"/"+aml_file_name+"_indels_dbsnp_non_zero.avinput.variant_function",header=None,sep='\t')
