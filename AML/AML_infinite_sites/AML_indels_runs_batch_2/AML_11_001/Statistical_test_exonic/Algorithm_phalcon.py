...
# Find best likelihoods among a set of chosen number of clusters
    ...
    cluster_labels = np.loadtxt('/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/'+data+'/'+data+'_indels_inferred_cluster_labels.txt',dtype='float')
...
countFileName = '/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/'+data+'/ReadCounts_'+data+'.tsv'
qualityFileName = '/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/'+data+'/GQ_'+data+'.tsv'
...
df_for_sites = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/AML_indels_nonbulk_evident_exonic_sites_dbsnp_nonzero_statistical_BF_test.tsv",sep='\t')
