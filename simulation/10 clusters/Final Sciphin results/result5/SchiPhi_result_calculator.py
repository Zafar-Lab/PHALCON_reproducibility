...
vcf_obtained = np.loadtxt('data_5_2000_10.vcf',dtype='str')
...
vcf_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/10 clusters/Data 5/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)
# the original genotype matrix from simulation
df_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/10 clusters/Data 5/simulation/Genotype_data_2000_50.tsv',sep='\t',header=None)
