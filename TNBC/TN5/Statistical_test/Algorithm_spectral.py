...
argParser.add_argument('-o', '--outputPrefix', type=str,default=data+'_orig_spectral_bf_test_')
...
list_bulk_evidence_not_found = [33762586,127379885,95590736,54647271,1284370]
df = df[df[1].isin([1284370])]
print(df)
df = df.to_numpy()
...
if isQualityFilteringOn: 
   ...
   df_gq = df_gq[df_gq[0].isin([1284370])]
...
Labelfile = '/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Spectral_prior_FINAL/Statistical_test/'+data+'_orig_spectral_inferred_cluster_labels_modified.txt'   # True cell to cluster map
