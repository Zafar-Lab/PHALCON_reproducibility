...
data_no = '1'
vcf_obtained = np.loadtxt('data_'+data_no+'_2000_7.vcf',dtype='str')
...
vcf_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/7 clusters/Data '+data_no+'/simulation/sc_2000_inclusion_output.vcf',sep='\t',header=None)
# the original genotype matrix from simulation
df_orig = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/7 clusters/Data '+data_no+'/simulation/Genotype_data_2000_50.tsv',sep='\t',header=None)
...
df_for_comparison.T.to_csv('Dataframe_for_comparing_results_more_than_one',index=False,header=False)
df_orig = pd.read_csv('Dataframe_for_comparing_results_more_than_one',header=None,index_col=None)
print(df_orig.shape)
