...
vcf_file_name = '/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Spectral_prior_FINAL/'+data+'_orig_spectral_outputInference.vcf'
...
print(vcf_df)
final_df_manual = pd.read_csv('/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Spectral_prior_FINAL/'+data+'_orig_spectral_final_df_manual_sites_removed.tsv',header=None,sep=',')
...
with open('/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Spectral_prior_FINAL/'+data+'_orig_spectral_non_zero_outputInference.vcf',"w") as vcfFile:
    pos = vcf_np.shape[0]
...
vcf_file_name = '/home/priya/Downloads/Final_Stage/Real Data Results/'+data+'/Spectral_prior_FINAL/'+data+'_orig_spectral_non_zero_outputInference.vcf'
np_obj = np.loadtxt(vcf_file_name,dtype='object')
vcf_df = pd.DataFrame(np_obj,dtype='object')
print(vcf_df)
genotype_arr = np.zeros((np_obj.shape[0],np_obj.shape[1]-9+4),dtype='object')
