...
argParser.add_argument('-r', '--minReadDepth', type=int, default=5) # read depth low
argParser.add_argument('-q', '--minGenotypeQuality',type=int, default=25)
argParser.add_argument('-a', '--minAltAlleleFrequency', type=float, default=0.2)
argParser.add_argument('-v', '--minVarThreshold', type=float, default=0.25)  # lower variant removal threshold
...
outputPrefixName = data + "_indels_"
...
print("Count file name :",countFileName)
print("GQ file name:",qualityFileName)
...
for resol in [0.1,0.12,0.13,0.14]:
