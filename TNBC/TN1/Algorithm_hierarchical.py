...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Real Data Results/TN1/readCounts_MBTN1_nodups.tsv')
argParser.add_argument('-g', '--inQualityFileName', type=str,default = '/home/priya/Downloads/Final Stage/Real Data Results/TN1/gq_file_TN1.tsv')
argParser.add_argument('-o', '--outputPrefix', type=str,default='TN1_orig_hierarchical_')
...
argParser.add_argument('-s', '--seed', type=int, default = 1091)
