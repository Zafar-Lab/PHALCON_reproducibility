...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Benchmarking/ADO_decreased_01/Data_4/simulation/sc_2000_readCounts_4.tsv')  # CHANGE HERE
...
argParser.add_argument('-s', '--seed', type=int, default = 114423129)
