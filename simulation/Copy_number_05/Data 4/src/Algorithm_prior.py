...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final_Stage/Benchmarking/Copy_number_05/Data 4/simulation/sc_2000_readCounts_4.tsv')  # CHANGE HERE
...
argParser.add_argument('-s', '--seed', type=int, default = 125493)
