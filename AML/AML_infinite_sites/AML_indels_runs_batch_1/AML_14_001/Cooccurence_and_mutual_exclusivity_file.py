...
multi_anno_file = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_1/"+data+"/"+data+"_indels_dbsnp_non_zero.hg19_multianno_for_cooccurrence_and_mutual_exclusivity.txt",sep='\t')
...
pd.concat(frames).to_csv("maf_file_14_001_for_cooccurence_and_mutual_exclusivity.txt",index=False,sep='\t')