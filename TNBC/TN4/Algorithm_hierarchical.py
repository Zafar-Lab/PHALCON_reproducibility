...
argParser.add_argument('-i', '--inReadCountFileName', type=str, default = '/home/priya/Downloads/Final Stage/Real Data Results/TN4/readCounts_MBTN4_nodups.tsv')
argParser.add_argument('-g', '--inQualityFileName', type=str,default = '/home/priya/Downloads/Final Stage/Real Data Results/TN4/gq_file_TN4.tsv')
argParser.add_argument('-o', '--outputPrefix', type=str,default='TN4_orig_hierarchical_')
...
for key in list(cluster_dict.keys()):
    ...
    if colony.shape[0] == 1435 or colony.shape[0] == 1644:
