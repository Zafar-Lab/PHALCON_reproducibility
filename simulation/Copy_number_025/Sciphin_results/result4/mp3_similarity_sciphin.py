...
vcf_obtained = np.loadtxt('data_cpn_025_'+str(data_no)+'_2000_'+str(no_clusters)+'.vcf',dtype='object')
...
with open('data_cpn_025_'+str(data_no)+'_2000_'+str(no_clusters)+'.gv','r') as f:
  content = f.readlines()
...
with open('Sciphin_cpn_025_'+str(no_clusters)+'_2000_data_'+str(data_no)+'_empty_removed.gv','w') as f:
  f.write('digraph G {\n')
  for node in t.traverse("preorder"):
