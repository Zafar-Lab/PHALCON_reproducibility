...
mutated_pos = np.array(np.loadtxt('/home/priya/Downloads/Final Stage/Benchmarking/'+no_clusters+' clusters/Data '+data_no+'/simulation/sc_2000_inclusion_output.vcf',dtype='object')[:,1],dtype='int')

print("Total number of sites ",len(mutated_pos))
