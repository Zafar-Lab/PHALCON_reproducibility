...
multi_anno_file = pd.read_csv("/home/priya/Downloads/Final_Stage/AML_Results/AML_indels_runs_batch_2/AML_81_001/AML_81_001_indels_dbsnp_non_zero.hg19_multianno.txt",sep='\t')
...
for variant in range(df_genotype.shape[0]):
   ...
   for cell in range(1, numcells+1):
      if df_genotype[variant][cell] == 1:
         ...
         multi_anno['Cell_Barcode'] = "cell"+str(cell)
