...
def parse_args():
    ...
    p.add_argument("-d", "--data",       type=str,   default="AML_105_001")
    p.add_argument("-s", "--seed",       type=int,   default=17215)
    p.add_argument("--min_dist",         type=float, default=0.2)
    p.add_argument("--n_neighbors",      type=int,   default=15)
    p.add_argument("--outdir",           type=str,   default="/home/priya/Downloads/Final_Stage/AML_results_finite_sites/AML_indels_run_finite_sites_batch_2/AML_105_001/visualisation/")
    p.add_argument("--cluster_labels_file",                type=str, default='AML_105_001_indels_finite_sites_inferred_cluster_labels.txt')
    p.add_argument("--vcf_file",                           type=str, default='AML_105_001_indels_nonzero_dbsnp_finite_sites_outputInference.vcf')
    p.add_argument("--variant_function_file",              type=str, default='AML_105_001_indels_dbsnp_non_zero_finite_sites.avinput.variant_function')
    p.add_argument("--lklhd_file",                         type=str, default='AML_105_001_indels_finite_sites_final_lklhds.tsv')
    p.add_argument("--newick_file",                        type=str, default='AML_105_001_indels_finite_sites_inferred_tree.nw')
    p.add_argument("--final_df_file",         type=str, default='AML_105_001_indels_finite_sites_final_df.tsv')
