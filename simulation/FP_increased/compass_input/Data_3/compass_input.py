...
data_no = '3'
no_clusters = 'fp_inc'
orig_df = pd.read_csv('/home/priya/Downloads/Final Stage/Benchmarking/FP_increased/Data_'+data_no+'/simulation/sc_2000_readCounts_'+data_no+'.tsv',header=None, sep='\t')
mutated_pos = np.array(np.loadtxt('/home/priya/Downloads/Final Stage/Benchmarking/FP_increased/Data_'+data_no+'/simulation/sc_2000_inclusion_output.vcf',dtype='object')[:,1],dtype='int')
